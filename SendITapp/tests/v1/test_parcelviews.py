...
class TestParcelViews(unittest.TestCase):
    ...
    def test_create_parcel_order(self):
        ...
        data=json.dumps(data), content_type='application/json;charset=utf-8')
    ...
    def test_create_parcel_missing_sender(self):
        """Function tests creating a parcel."""
        response = self.app.post('/api/v1/parcels', 
        data=json.dumps(missing_sender), content_type='application/json;charset=utf-8')
        result = json.loads(response.data)
    ...
    def test_create_parcel_incorrect_sender(self):
        """Function tests creating a parcel."""
        response = self.app.post('/api/v1/parcels', 
        data=json.dumps(incorrect_sender), content_type='application/json;charset=utf-8')
        result = json.loads(response.data)
    ...
    def test_create_order_with_missing_destination(self):
        """Function tests creating a parcel with incomplete data."""
        response = self.app.post('/api/v1/parcels', 
        data=json.dumps(missing_destination), content_type='application/json;charset=utf-8')
        result = json.loads(response.data)
    ...
    def test_create_order_with_incorrect_recipient(self):
        """Function tests creating a parcel with incomplete data."""
        response = self.app.post('/api/v1/parcels', 
        data=json.dumps(incorrect_recipient), content_type='application/json;charset=utf-8')
        result = json.loads(response.data)
    ...
    def test_create_order_with_missing_recipient(self):
        """Function tests creating a parcel with incomplete data."""
        response = self.app.post('/api/v1/parcels', 
        data=json.dumps(missing_recipient), content_type='application/json;charset=utf-8')
        result = json.loads(response.data)
    ...
    def test_create_order_with_missing_weight(self):
        """Function tests creating a parcel with incomplete data."""
        response = self.app.post('/api/v1/parcels', 
        data=json.dumps(missing_weight), content_type='application/json;charset=utf-8')
        result = json.loads(response.data)
    ...
    def test_create_order_with_incorrect_weight(self):
        """Function tests creating a parcel with incomplete data."""
        response = self.app.post('/api/v1/parcels', 
        data=json.dumps(incorrect_weight), content_type='application/json;charset=utf-8')
        result = json.loads(response.data)
    ...
    def test_create_order_with_incorrect_status(self):
        """Function tests creating a parcel with incomplete data."""
        response = self.app.post('/api/v1/parcels', 
        data=json.dumps(incorrect_status), content_type='application/json;charset=utf-8')
        result = json.loads(response.data)
